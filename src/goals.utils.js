...
;(function(doc) {
    /** @type {GoalsUtils} */
    var utils = {};
    utils.getURIParameter = function(name) {
    ...
    utils.isNull = function(arg) {return Object.prototype.toString.call(arg) === '[object Null]'};
    utils.isUndefined = function(arg) {return Object.prototype.toString.call(arg) === '[object Undefined]'};
    utils.isString = function(arg) {return Object.prototype.toString.call(arg) === '[object String]'};
    utils.isNumber = function(arg) {return Object.prototype.toString.call(arg) === '[object Number]'};
    utils.isBoolean = function(arg) {return Object.prototype.toString.call(arg) === '[object Boolean]'};
    utils.isFunction = function(arg) {return Object.prototype.toString.call(arg) === '[object Function]'};
    utils.isDate = function(arg) {return Object.prototype.toString.call(arg) === '[object Date]'};
    utils.isArray = function(arg) {return Object.prototype.toString.call(arg) === '[object Array]'};
    utils.isObject = function(arg) {return Object.prototype.toString.call(arg) === '[object Object]'};
    utils.isRegExp = function(arg) {return Object.prototype.toString.call(arg) === '[object RegExp]'};
    ...
    (function() {
        ...
        utils.getTagNameData = function(el) {
            var result = {};
        ...
        utils.setTagNameData = function(el, data) {
            if(!data) {
                data = {};
            }
            var inputs = el.querySelectorAll('input');
    ...
    utils.on = function(selector, bubbling, event, fn) {
        var type;
        if(bubbling[0] == ".") {
    ...
    utils.hover = function(selector, inFn, outFn) {
    ...
    utils.bindCheckbox = function(elem, pelem, clazs) {
        Goals.assert($, "You must import the 'jQuery' package");
        var $elem = $(elem);
        var $pelem = $(pelem);
        var flag;
    ...
    utils.getCheckedElems = function(pelem, clazs) {
        Goals.assert($, "You must import the 'jQuery' package");
    ...
    utils.getCheckedIndexs = function(pelem, clazs) {
        Goals.assert($, "You must import the 'jQuery' package");
        var $selectors = $(pelem).find(clazs);
        var result = [];
        for(var i = 0; i < $selectors.length; i++) {
    ...
    (function() {
        ...
        utils.pulldown = function(inputElems, dataArray, searchFields, settings) {
            Goals.assert($, "You must import the 'jQuery' package");
